...
```{r}
results_compiled$elapsed <- results_compiled$time.end - results_compiled$time.start

ggplot(results_compiled, aes(x = elapsed, y = BalancedAccuracy)) +
  geom_point() +
  theme_minimal()
```
