...
bootstrap_7 = c(bootstrap[15], bootstrap[20], bootstrap[30])
# input_features = c("Baseline", "All")
input_features_7 = c("All")
imbalance = c("none", "weighted", "up", "smote", "rose")
imbalance_7 = c("weighted", "up", "smote", "rose")
  ...
  for (j in input_features) {
    ...
    for (k in imbalance) {
      ...
      for (m in mlMethod) {
        ...
        write_csv(results_compiled, "../data/results_compiled_6.csv")
      }
    }
  }
}
