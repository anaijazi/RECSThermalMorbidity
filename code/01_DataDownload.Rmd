...
recs_subset <- recs_recode %>%
  select(DBT1, DBT99, WHITE, BLACK, ASIAN, MIXED, OTHER_RACE, SDESCENT, OVER65, LIVESALONE, LARGEHOUSE, POVERTY, EMPLOYHH, HIGHSCHOOL, RENT, PAYSUTL, APARTMENT, MOBILE, YEARMADERANGE, THERMALMASS.WALL, THERMALMASS.ROOF, ADQINSUL, DRAFTY, WWR, TYPEGLASS, COOLTYPE, EQUIPM, HVAC_OPERATION, HVAC_MAINTENANCE, NUMFANS, OFFGRID, TEMPMA)
```
